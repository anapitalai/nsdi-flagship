...
export const dashboardMockData: {
  ...
  items: [
    ...
    {
      id: "item_vector_roads",
      name: "roads_core_network_2024.gpkg",
      itemTypeId: "type_vector",
      collectionIds: ["col_road_ml"],
      format: "GeoPackage",
      size: "410 MB",
      epsg: 32755,
    ...
    {
      id: "item_vector_boundaries",
      name: "district_boundaries_2024.geojson",
      itemTypeId: "type_vector",
      collectionIds: ["col_morobe_survey"],
      format: "GeoJSON",
      size: "52 MB",
    ...
    {
      id: "item_gnss_station",
      name: "base_station_rinex_2024_07.obs",
      itemTypeId: "type_gnss",
      collectionIds: ["col_height_control"],
      format: "RINEX 4",
      size: "145 MB",
    ...
    {
      id: "item_reference_wkt",
      name: "png2020_geodetic_crs.wkt",
      itemTypeId: "type_reference",
      collectionIds: ["col_height_control"],
      format: "WKT",
      size: "2 KB",
